...
class addRecipeView extends View {
  ...
  _message = 'New recipe has been uploaded :)';
  ...
  defaultMarkup() {
    ...
    <div class="upload__column">
        ...
        <label>Title</label>
        <input value="TEST356" required name="title" type="text" />
        <label>URL</label>
        <input value="TEST356" required name="sourceUrl" type="text" />
        <label>Image URL</label>
        <input value="TEST356" required name="image" type="text"/>
        <label>Publisher</label>
        <input value="TEST356" required name="publisher" type="text" />
  ...
  //   addHandlerShowModal() {
  //     this._btnOpen.addEventListener('click', this.toggleWindow); -> this doesn't work because the this keyword points to the window itself
  //   }
  //   addHandlerShowModal() {
  //     this._btnOpen.addEventListener('click', function(){
  // this.toggleWindow()   -> this doesn't work because here the this keyword points to the _btnOpen itself
  // });
  //   }
